...
], UserController.prototype, "listarUsers", null);
__decorate([
    (0, common_1.Get)(':id'),
    ...
    __metadata("design:returntype", Promise)
], UserController.prototype, "buscarUserPorId", null);
__decorate([
    (0, common_1.Post)(),
    ...
    __metadata("design:returntype", Promise)
], UserController.prototype, "adicionarUser", null);
__decorate([
    (0, common_1.Put)(':id'),
    __param(0, (0, common_1.Param)('id')),
    ...
    __metadata("design:returntype", Promise)
], UserController.prototype, "atualizarUser", null);
__decorate([
    ...
    __metadata("design:paramtypes", [String]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "removerUser", null);
__decorate([
    (0, common_1.Post)(':userId/pedidos'),
    __param(0, (0, common_1.Param)('userId')),
    __param(1, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, Pedidos_1.Pedidos]),
    __metadata("design:returntype", Promise)
], UserController.prototype, "adicionarPedido", null);
